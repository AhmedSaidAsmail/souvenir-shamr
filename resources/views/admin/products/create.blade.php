                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade gallery-wrapper" id="nav-gallery" role="tabpanel"
                                ...
                                <div class="row single-input">
                                    <div class="col-md-11">
                                        <input type="file" class="form-control" name="product[gallery][]">
                                    </div>
                                    <div class="col-md-1">
...
//            var content = $(this).closest('.gallery-wrapper').find('.single-input').html();
            $(this).closest('.gallery-wrapper').append('<div class="row single-input">' + content + '</div>');
            removeGallery();
        });
