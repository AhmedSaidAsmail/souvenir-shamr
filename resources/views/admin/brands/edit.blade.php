    ...
    <div class="col-md-10 offset-md-2 main-interface">
        ...
        <section class="content">
            <div class="card form-wrapper">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.brands.update',['id'=>$brand->id])}}" id="basic_form">
                        {{csrf_field()}}
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="brand[en_name]" class="form-control"
                                               placeholder="English name" value="{{$brand->en_name}}"
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="brand[ar_name]" class="form-control"
                                               placeholder="Arabic name" value="{{$brand->ar_name}}"
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="brand[ru_name]" class="form-control"
                                               placeholder="Russian name" value="{{$brand->ru_name}}"
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="brand[it_name]" class="form-control"
                                               placeholder="Italian name" value="{{$brand->it_name}}"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="brand[status]" required>
                                        ...
                                        <option value="0" {!! !$brand->status?"selected":null !!}>Pending</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
